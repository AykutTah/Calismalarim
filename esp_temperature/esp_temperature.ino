...
#define wifi_password "231087323"
#define mqtt_server "m20.cloudmqtt.com"
#define mqtt_user "gghzpkev"
#define mqtt_password "fzVPQQOzXWZy"
#define topic1 "ab2017/aykutt/sayi"
#define topic2 "ab2017/temperaturex"
#define topic3 "speedx"
#define readSize 6


void callback(char* topic, byte* payload, unsigned int length);
WiFiClient espClient;
PubSubClient client(mqtt_server, 18379, callback, espClient);
//int i=65635;
...
void callback1(char* topic, byte* payload, unsigned int length) {
  char rxBuffer[6]; //Gelen datayı okumak için bir Buffer dizisi tanımlıyoruz.
  Serial.println(); 
